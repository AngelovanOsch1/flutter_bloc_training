...
class _SeriesListScreenState extends State<SeriesListScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          SeriesBloc(SeriesRepository())
            ..add(SeriesEvent.fetchSeries(page: currentPage)),
      child: Scaffold(
        appBar: AppBar(
          title: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () async {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => CreateSeriesScreen()),
                  );
                },
              ),
            ],
                      ...
                      loaded: (seriesList) => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              '${series.type} • Episodes: ${series.episodeCount}',
                            ),
                            trailing: Row(
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    context.read<SeriesBloc>().add(
                                      SeriesEvent.deleteSeries(series.id),
                                    );

                                    // Refresh the list after editing
                                    context.read<SeriesBloc>().add(
                                      SeriesEvent.fetchSeries(
                                        page: currentPage,
                                      ),
                                    );
                                  },
                    ...
                    ElevatedButton(
                      onPressed: currentPage > 1
                          ? () {
                              ...
                              context.read<SeriesBloc>().add(
                                SeriesEvent.fetchSeries(page: currentPage),
                              );
                            }
                          : null,
